...
print(result[0:4])
# index slicing is when you get a substring of a sting \
# ex. my_text = 'this is a text ' is the sting and print(result[0:4]) is a substring which includes "this"
# includes the first number and does not include the last 
...
# reverse a string 
# print(result[::-1])
# get the last letter of the sting 
print(result[-1])
print(result.find('string'))
print(result[15:-1])

# when you get a -1 response in the terminal, it means a variable like "hancock" below doesn't exist
print(result.find('hancock'))

#get the index of the third letter from the end of the text
print(result[-3])
#get the index of the fifth letter from the end of the text
print(result[-5])
...
substring = text[2:5]
print(substring)
# get the first letter all the way to the end
print(text[0:])
